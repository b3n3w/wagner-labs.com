			...
			<div class="flex w-full justify-center md:w-1/2 md:justify-end">
				<div class="relative h-80 w-64 overflow-hidden md:h-96 md:w-80">
				 ...
				 background-image:
				   ...
				   linear-gradient(to bottom, #0f0f1a 0%, transparent 20%, transparent 65%, #0f0f1a 100%),
				   radial-gradient(circle at top left, #0f0f1a 0%, transparent 10%),
				   radial-gradient(circle at top right, #0f0f1a 0%, transparent 10%),
				   radial-gradient(circle at bottom left, #0f0f1a 0%, transparent 10%),
				   radial-gradient(circle at bottom right, #0f0f1a 0%, transparent 10%);
			   "
					></div>
				</div>
			</div>
